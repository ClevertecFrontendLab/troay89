...
export const MainContent: React.FC<MainPageProps> = ({ isCloseSide }) => {
        ...
        <Content className='site-layout-background'>
            <Card className={`main-card-about ${changeMargin}`}>
                <p>
                    ...
                    <br />— создавать свой профиль, где {spaceMobile} ты можешь загружать свои фото,
                    видео и отзывы {spaceTableDefault} {spaceDesktop} о тренировках;
            ...
            <Card className={`main-card-tagline ${changeMargin}`}>
                <h4 style={isMobile ? { padding: MobilePadding } : undefined}>
                    ...
                    личный помощник {spaceTableDefault} {spaceDesktop} в мире фитнеса. Не откладывай
