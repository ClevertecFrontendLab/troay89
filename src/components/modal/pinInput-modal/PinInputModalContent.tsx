...
export const PinInputModalContent = ({
    verifyOtp,
    isError,
    isOpen,
    onClose,
    onOpenNextModule,
}: PinInputModalConentProps) => {
...
export const PinInputModalWithLoader = withLoader(PinInputModalContent);
